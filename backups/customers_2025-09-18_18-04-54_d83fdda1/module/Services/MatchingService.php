 ...
 */
class MatchingService extends BaseService implements ServiceInterface
{
    ...
    public function isHealthy(): bool
    {
        try {
            ...
            return is_array($this->matchingConfig);
        } catch (\Exception $e) {
            $this->logger->error('MatchingService health check failed', [
                'error' => $e->getMessage()
            ]);
            return false;
        }
