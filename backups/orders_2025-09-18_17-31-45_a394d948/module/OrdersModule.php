...
class OrdersModule implements ModuleInterface
{
    ...
    private ?OrdersServiceFactory $serviceFactory = null;
    ...
    /**
     * Lazy loading dos services via Factory
     */
    private function getOrderService(): OrderService
    {
        if ($this->orderService === null) {
            $this->orderService = $this->getServiceFactory()->create('order');
        }
    ...
    private function getOrderStatusService(): OrderStatusService
    {
        if ($this->orderStatusService === null) {
            $this->orderStatusService = $this->getServiceFactory()->create('order_status');
        }
    ...
    private function getUpsellOrderService(): UpsellOrderService
    {
        if ($this->upsellOrderService === null) {
            $this->upsellOrderService = $this->getServiceFactory()->create('upsell_order');
        }
    ...
    private function getOrderAnalyticsService(): OrderAnalyticsService
    {
        if ($this->orderAnalyticsService === null) {
            $this->orderAnalyticsService = $this->getServiceFactory()->create('order_analytics');
        }
        return $this->orderAnalyticsService;
    }

    /**
     * Lazy loading da Service Factory
     */
    private function getServiceFactory(): OrdersServiceFactory
    {
        if ($this->serviceFactory === null) {
            $this->serviceFactory = $this->sdk->createOrdersServiceFactory();
        }
