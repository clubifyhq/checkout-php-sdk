 ...
 */
class OrderAnalyticsService extends BaseService implements ServiceInterface
{
    /**
    ...
    {
        return 'order_analytics_service';
    }
    ...
    {
        try {
            // Test basic functionality with a simple statistics call
            $this->getStatistics(['limit' => 1]);
            return true;
        } catch (\Exception $e) {
            $this->logger->error('OrderAnalyticsService health check failed', [
                'error' => $e->getMessage()
            ]);
            return false;
        }
    ...
    public function getConfig(): array
    {
        return [
            ...
            'endpoints' => [
                ...
                'revenue_stats' => '/orders/revenue-statistics',
                'top_customers' => '/orders/top-customers',
                'top_products' => '/orders/top-products',
                'conversion_metrics' => '/orders/conversion-metrics'
            ],
            'features' => [
