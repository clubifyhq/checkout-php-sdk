 ...
 * order bumps, flows e todas as configurações de conversão.
 *
...
class OfferData extends BaseData
{
    ...
    /**
     * Define configuração de flow
     */
    public function setFlowConfig(array $config): self
    {
        $this->flow_config = $config;
        $this->data['flow_config'] = $config;
        return $this;
    }
    ...
    /**
     * Obtém order bumps configurados
     */
    public function getOrderBumps(): array
    {
        return $this->order_bumps ?? [];
    }

    /**
     * Adiciona order bump
     */
    public function addOrderBump(array $orderBump): self
    {
        if (!is_array($this->order_bumps)) {
            $this->order_bumps = [];
        }

        $this->order_bumps[] = $orderBump;
     ...
     * Remove order bump
     */
    public function removeOrderBump(string $orderBumpId): self
    {
        if (is_array($this->order_bumps)) {
    ...
    /**
     * Verifica se tem order bumps
     */
    public function hasOrderBumps(): bool
    {
        return !empty($this->getOrderBumps());
    }
    ...
    /**
     * Define experimentos A/B
     */
    public function setExperiments(array $experiments): self
    {
    ...
    /**
     * Verifica se tem experimentos ativos
     */
    public function hasActiveExperiments(): bool
    {
    ...
    public function toPublic(): array
    {
        return [
            ...
            'has_order_bumps' => $this->hasOrderBumps(),
    ...
    public function toAdmin(): array
    {
        return array_merge($this->toPublic(), [
            ...
            'order_bumps' => $this->getOrderBumps(),
            ...
            'has_active_experiments' => $this->hasActiveExperiments(),
