 ...
 *
 * Responsável pelas operações de cobrança e billing:
 * - Processamento manual de cobrança
 * - Gestão de faturas e histórico
 * - Gestão de métodos de pagamento
 * - Billing prorrateado
 * - Geração de faturas
 *
 * Segue os princípios SOLID:
 * - S: Single Responsibility - Gerencia apenas operações de billing
 * - O: Open/Closed - Extensível via herança
 * - L: Liskov Substitution - Implementa ServiceInterface
 * - I: Interface Segregation - Métodos específicos de billing
...
class BillingService implements ServiceInterface
{
    ...
    public function isHealthy(): bool
    {
        try {
            ...
            $this->logger->error('BillingService health check failed', [
                'error' => $e->getMessage()
            ]);
            return false;
        }
    ...
    public function getConfig(): array
    {
        return [
            ...
            'billing_intervals' => ['monthly', 'quarterly', 'yearly'],
